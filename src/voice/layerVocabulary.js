...
const SPOKEN_ALIASES = Object.freeze({
  ...
  'fr-hydro-plants': ['centrales hydro', 'petite hydro', 'hydroélectricité', 'hydroelectricite', 'hydroélectriques', 'hydroelectriques', 'barrages hydroélectriques', 'barrages hydroelectriques', 'small hydro'],
  ...
  'local-dams': ['barrages', 'barrage', 'digues', 'digue', 'barrages et digues'],
